...
public class DeleteCakeController extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(DeleteCakeController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.deleteCake(cakeId)) {
                url = AppConstants.SEARCH;
                LOGGER.info("Delete Cake Success");
            } else {
                LOGGER.info("Delete Cake Fail");
            }
